...
<head>
    ...
    <title>User Management - Server Assessment System</title>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/users/edit/<?php echo $user['id']; ?>" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <a href="/users/setPassword/<?php echo $user['id']; ?>" class="btn btn-sm btn-outline-secondary">
